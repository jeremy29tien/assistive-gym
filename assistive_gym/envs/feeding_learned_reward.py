...
class FeedingLearnedRewardEnv(FeedingEnv):
    reward_net_path = "/Users/jeremytien/Documents/3rd-Year/Research/Anca Dragan/assistive-gym/trex/models/test1.params"
    reward_net = None
    device = None
    ...
    def __init__(self, robot, human):
        ...
        self.reward_net = Net()
        self.reward_net.load_state_dict(torch.load(self.reward_net_path))
