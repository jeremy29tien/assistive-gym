...
for seed in 0 1 2; do
  ...
  cd trex/
  python3 model.py ${var1} --augmented --num_demos 10 --all_pairs --num_epochs 100 --patience 10 --lr 0.01 --weight_decay 0.01 --l1_reg 0.01 --seed $seed --reward_model_path $reward_model_path > $reward_output_path
