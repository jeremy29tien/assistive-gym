...
for seed in 0 1 2; do
  ...
  config="scratch_itch/feature_sensitivity/${var1}raw_augmented_linear_2000prefs_60pairdelta_100epochs_10patience_001lr_01l1reg"
  ...
  python3 -m assistive_gym.learn --env "ScratchItchLearnedRewardJaco-v0" --algo ppo --seed $seed --train --train-timesteps 1000000 --reward-net-path $reward_model_path --indvar ${var1} --save-dir $policy_save_dir
