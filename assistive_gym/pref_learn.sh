...
for seed in 0 1 2; do
  ...
  cd trex/
  python3 model.py --feeding --num_demos ${var1} --hidden_dims 128 64 --fully_observable --all_pairs --num_epochs 100 --patience 10 --lr 0.001 --weight_decay 0.00001 --seed $seed --reward_model_path $reward_model_path > $reward_output_path
