...
for seed in 0 1 2; do
  ...
  #Reward-learning
  config="capacity_experiment/linear_2000prefs_60pairdelta_100epochs_10patience_001lr_001weightdecay_001l1reg"
  ...
  python3 trex/linear_model.py --num_comps 2000 --pair_delta 60 --num_epochs 100 --patience 10 --lr 0.01 --weight_decay 0.01 --l1_reg 0.01 --seed $seed --test --reward_model_path $reward_model_path > $reward_output_path
