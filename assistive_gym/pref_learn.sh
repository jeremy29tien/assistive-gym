...
for seed in 0 1 2; do
  ...
  config="scratch_itch/vanilla/new_pure_fully_observable/${var1}demos_allpairs_hdim128-64_100epochs_10patience_000001lr_00001weightdecay"
  ...
  cd trex/
  python3 model.py --scratch_itch --seed $seed --new_pure_fully_observable --hidden_dims 128 64 --num_demos ${var1} --all_pairs --num_epochs 100 --patience 10 --lr 0.00001 --weight_decay 0.0001 --reward_model_path $reward_model_path > $reward_output_path
