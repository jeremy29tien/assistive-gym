...
for seed in 0 1 2; do
  ...
  config="feeding/vanilla/40demos_allpairs_hdim256-256-256_100epochs_10patience_0001lr_0001weightdecay"
  ...
  cd trex/
  python3 model.py --feeding --seed $seed --fully_observable --hidden_dims 256 256 256 --num_demos 40 --all_pairs --num_epochs 100 --patience 10 --lr 0.001 --weight_decay 0.001 --reward_model_path $reward_model_path > $reward_output_path
