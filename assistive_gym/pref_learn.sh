...
for seed in ${var1}; do
  ...
  config="scratch_itch/vanilla/324demos_hdim128-64_fullyobservable_allpairs_100epochs_10patience_0001lr_0001weightdecay"
  ...
  cd trex/
  python3 model.py --scratch_itch --num_demos 324 --hidden_dims 128 64 --fully_observable --all_pairs --num_epochs 100 --patience 10 --lr 0.001 --weight_decay 0.001 --seed $seed --reward_model_path $reward_model_path > $reward_output_path
