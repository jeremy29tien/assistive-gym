...
def evaluate_policies(infile, outdir):
    ...
    for policy_path in policy_paths:
        if policy_path:
            ...
            sconfig = "feeding/vanilla/40demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay"
            ...
            mconfig = "feeding/vanilla/120demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay"
            ...
            lconfig = "feeding/vanilla/324demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay"
    ...
    np.save(outdir + "/40demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay_learnedrewards.npy", slearned_reward_means)
    np.save(outdir + "/120demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay_learedrewards.npy", mlearned_reward_means)
    np.save(outdir + "/324demos_hdim128-64_stateaction_allpairs_100epochs_10patience_0001lr_000001weightdecay_learnedrewards.npy", llearned_reward_means)
